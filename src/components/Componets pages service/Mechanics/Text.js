    ...
    return(
        <div className="color-bg" id="float"> 
            ...
            <div className="zone-de-text" id="float">
                <p>
                Mechanical services refer to the various stages involved in providing mechanical systems or services for a building or construction project, including planning, design, installation, operation and maintenance. Providing mechanical services requires quality and testing to ensure that all required specifications and requirements are met to create a highly successful project.
                </p>
            </div>
