    ...
    return(
        <div className="color-bg" id="float"> 
            ...
            <div className="zone-de-text" id="float">
                <p>
                    Carpentry services refers to the various stages involved in providing carpentry work or services for a building or construction project, including planning, design, execution and maintenance. Providing carpentry services requires quality and testing to ensure that all required specifications and requirements are met to create a highly successful project.
                </p>
            </div>
